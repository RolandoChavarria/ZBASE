...
*//
*//© 2023.  For more information, contact Deloitte Touche Tohmatsu Limited.  All rights reserved.
*//
*//====================================================================
...
IF ck_pop <> 'X' OR sy-subrc <> 0.
  IF ISTABLE_TVAK = 'Yes'.
    ...
    COLUMN_TVAK = 'AUART BEZOB CMGRA KLIMP MANDT VBTYP KALVG'.
    TABLE_TVAK = 'TVAK'.
...
FORM sub_download_acct_config.
  ...
  APPEND ls_table TO lt_table .
  CLEAR ls_table.
  CONCATENATE 'Extract Script Version' '|^|' '19.1' INTO ls_table .
  APPEND ls_table TO lt_table .
  CLEAR ls_table.
 ...
 s_end INTO ls_table .
  ...
  ELSE.
    ...
    ' ' INTO ls_table .
      APPEND ls_table TO lt_table .
  CLEAR ls_table .
    CONCATENATE 'SM20 Change Log Start Date' '|^|' INTO ls_table .
  APPEND ls_table TO lt_table .
  CLEAR ls_table .
*#ACTTSAP12.0 Release 12.0 Changes End*
  CONCATENATE 'SM20 Change Log End Date' '|^|' INTO ls_table .
  APPEND ls_table TO lt_table .
  CLEAR ls_table .
  ENDIF.
  PERFORM download_gui TABLES lt_table USING lv_file.
